...
# Export kable 
  table1_tbi %>%
   ...
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "No", "Yes", "", "")) %>%
   save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/table1/table1_tbi_mimiciv.pdf", zoom = 10)
...
# Export kable
 table1 %>%
   ...
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "No", "Yes", "", "")) %>%
   save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/table1/table1_hospdeath_mimiciv.jpg", zoom = 10)
...
# For console
 table1 %>%
   ...
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "Mortality at year"=2, "", ""))
...
table1_dataset <- final_dataset_MIMICIV[,c(vars_in_table1, stratifyby)]
table1_dataset$prolonged_mec_vent <- factor(table1_dataset$prolonged_mec_vent, labels = c("Non-PMV", "PMV"))
table1_dataset$anytrauma_anyseq <- factor(table1_dataset$anytrauma_anyseq, labels = c("No Trauma", "Any Trauma"))
cat_variables <- rep(NA, length(vars_in_table1))
...
# For console
 table1 %>%
   kbl(caption = "Table 1 of base model: Any Trauma VS no Trauma & Prolonged Mechanical Ventilation. MIMIC-IV Database" ,     align = "c") %>%
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "No Trauma"=2, "Any Trauma"=2, "", ""))
 
# Export kable
 table1 %>%
   kbl(caption = "Table 1 of base model: Any Trauma VS Prolonged Mechanical Ventilation. MIMIC-IV Database" ,     align = "c") %>%
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "No TBI and no Mec Vent", "TBI without Mec Vent", "No TBI and Mec Vent",     "TBI + Mec-Vent ", " ", " ")) %>%
...
# Table one: non-TBI trauma and PMV
...
table1_dataset <- final_dataset_MIMICIV[final_dataset_MIMICIV$trauma_type_anyseq=="non-TBI trauma",
                                        c(vars_in_table1, stratifyby)]
table1_dataset$prolonged_mec_vent <- factor(table1_dataset$prolonged_mec_vent, labels = c("Non-PMV", "PMV"))
cat_variables <- rep(NA, length(vars_in_table1))
...
# For console
 table1 %>%
   kbl(caption = "Table 1 of base model: non-TBI Trauma and Prolonged Mechanical Ventilation. MIMIC-IV Database" ,     align = "c") %>%
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "Non-TBI Trauma"=2, "", ""))
...
# Export kable
 table1 %>%
   ...
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "Non-TBI Trauma"=2, "", "")) %>%
   save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/table1/table1_nontbitrauma_and_pmv_mimiciv.jpg", zoom = 10)
```
