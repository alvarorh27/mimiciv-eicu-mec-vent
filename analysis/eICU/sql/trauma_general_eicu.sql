...
FROM sq1
WHERE diagnosisoffset = min_diagnosisoffset AND (traumatic_general_min_diagnosisoffset = 1  OR traumatic_general_any_diagnosisoffset = 1) --group when there is Traumatic general injury
