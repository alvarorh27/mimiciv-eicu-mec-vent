...
logreg_hospdeath <- glm(
   inhospital_death ~ age + sex + prolonged_mec_vent + aps + charlson,
...
htmlTable(or_hospdeath_2[,c("term","OR","OR_lower","OR_upper")], caption = "Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors. eICU Database")
...
or_table <- or_hospdeath_2 %>%
  ...
  arrange(desc(term)) %>%
  kbl(caption = "Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors. eICU Database" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/eICU/Odds_ratio/or_hospdeath_PMV_eicu.png",
             zoom = 10)
...
print(Sys.time())
logreg_hospdeath <- glm(
   inhospital_death ~ age + sex + trauma_type_anyseq + aps + charlson,
  data = final_dataset_eICU,
  family = binomial())
print(Sys.time())
```
