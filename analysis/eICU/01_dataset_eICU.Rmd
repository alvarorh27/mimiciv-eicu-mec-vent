...
imp <- mice(final_dataset_imputed[, vars_to_impute], 
            method = 'pmm', 
            m = 5, 
            exclude = c("subject_id", "hadm_id", "stay_id", "unitvisitnumber", "hospitaladmitoffset", "unitdischargeoffset", "hospitaldischargeoffset", "days_of_death", "death_30days", "gcs_original"),  #excludes variables from the imputation process
            seed = 123)
