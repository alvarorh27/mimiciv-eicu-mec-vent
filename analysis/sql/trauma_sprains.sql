WITH
  ...
  SELECT
    *,
    ...
    CASE
      WHEN (icd_code LIKE 'S434___' OR icd_code LIKE 'S435___' OR icd_code LIKE 'S436___' OR icd_code LIKE 'S438___' OR icd_code LIKE 'S439___' OR icd_code LIKE 'S134___' OR icd_code LIKE 'S135___' OR icd_code LIKE 'S138___' OR icd_code LIKE 'S139___' OR icd_code LIKE 'S039___' OR icd_code LIKE 'S034___' OR icd_code LIKE 'S038___' OR icd_code LIKE 'S731___' OR icd_code LIKE 'S635___' OR icd_code LIKE 'S636___' OR icd_code LIKE 'S638___' OR icd_code LIKE 'S639___' OR icd_code LIKE 'S234___' OR icd_code LIKE 'S233___' OR icd_code LIKE 'S238___' OR icd_code LIKE 'S239___' OR icd_code LIKE 'S134___' OR icd_code LIKE 'S135___' OR icd_code LIKE 'S138___' OR icd_code LIKE 'S139___' OR icd_code LIKE 'S834___' OR icd_code LIKE 'S835___' OR icd_code LIKE 'S836___' OR icd_code LIKE 'S838___' OR icd_code LIKE 'S839___' OR icd_code LIKE 'S534___' OR icd_code LIKE 'S335___' OR icd_code LIKE 'S336___' OR icd_code LIKE 'S338___' OR icd_code LIKE 'S936___' OR icd_code LIKE 'S761___' OR icd_code LIKE 'S934___' OR icd_code LIKE 'S935') AND (icd_code NOT LIKE '______D'AND icd_code NOT LIKE '______S') OR (icd_code BETWEEN '84%' AND '84899') AND seq_num=1 THEN 'YES'
    ELSE
    'NO'
  END
    AS sprain_seq_1,
...
FROM (
  ...
  FROM (
    ...
    HAVING
      sprain_any_seq='YES'
      OR sprain_seq_1='YES' -- to group when there is SPRAIN
    ORDER BY
      subject_id,
      hadm_id,
      sprain_seq_1))
WHERE
  NOT (hadm_id=prev_hadm_id
    AND sprain_seq_1='NO'
    AND sprain_any_seq='YES') --look at word
ORDER BY
  subject_id,
  hadm_id
