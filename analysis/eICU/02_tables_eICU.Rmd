...
generate_table1_subset <- function(subset_filter, title, save_name) {
  ...
  vars_in_table1 <- c('age', 'icu_stay_days', 'inhospital_death', 'aps', 'charlson')
  stratifyby <- "prolonged_mec_vent"
...
generate_table1_subset(
  ...
  title = "Baseline characteristics of the eICU non-trauma patient subset, stratified by PMV status",
...
generate_table1_subset(
  ...
  title = "Baseline characteristics of the eICU non-TBI trauma patient subset, stratified by PMV status",
...
generate_table1_subset(
  ...
  title = "Baseline characteristics of the eICU non-severe TBI patient subset, stratified by PMV status",
...
generate_table1_subset(
  ...
  title = "Baseline characteristics of the eICU severe TBI patient subset, stratified by PMV status",
