...
FROM sq1
WHERE diagnosisoffset = min_diagnosisoffset AND (traumatic_general_min_diagnosisoffset = 'YES'  OR traumatic_general_any_diagnosisoffset = 'YES') --group when there is Traumatic general injury
