...
final_dataset_MIMICIV_tbi_severe <- subset(final_dataset_MIMICIV, final_dataset_MIMICIV$trauma_type_anyseq=="tbi_severe") 
...
or_hospdeath_mimiciv_tbi_severe <- or_hospdeath_1[or_hospdeath_1[,1]=="prolonged_mec_vent", c(1,6:8)]
or_hospdeath_mimiciv_tbi_severe[, 1] <- "PMV for TBI severe"
...
# Save OR table and print in console
write.csv(or_hospdeath_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/or_hospdeath_PMV-for-TBI-severe_mimiciv.csv')
htmlTable(or_hospdeath_2[,c("term","OR","OR_lower","OR_upper")], caption = "Logistic Regression. Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors. Subset of TBI severe. MIMIC-IV Database")
...
or_table <- or_hospdeath_2 %>%
  ...
  mutate(
    ...
    OR_upper = ifelse(OR_upper <= 100, sprintf("%.2f", OR_upper), sprintf("%.2e", OR_upper))) %>%
  arrange(desc(term)) %>%
  kbl(caption = "Logistic Regression. Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors. Subset of TBI severe. MIMIC-IV Database" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Odds_ratio/or_hospdeath_PMV-for-TBI-severe_mimiciv.png",
             zoom = 10)
...
ggplot(or_hospdeath_2, 
  ...
  geom_errorbarh(height = 0.2, aes(color = adverse_protective)) +
  geom_vline(xintercept = 1, linetype = "dashed") +
  labs(x = "Odds Ratio", y = NULL, title = "Logistic Regression. Odds Ratio and Confidence Intervals\nfor Hospital Mortality-associated Factors.\nSubset of TBI severe. MIMIC-IV Database") +
  theme_minimal() +
  scale_color_manual(
    values = c("#c0392b", "#27ae60", "gray70"),
    labels = c("Adverse", "Protective", "Inconclusive"),
...
# Save the Forest plot as a PNG file
ggsave("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Forest_plot/fp_deathyear_PMV-for-TBI-severe_mimiciv.png", width = 10, height = 4, dpi = 300)
```
...
```{r}
# Create subset with tbi_severe
final_dataset_MIMICIV_tbi_nonsevere <- subset(final_dataset_MIMICIV, final_dataset_MIMICIV$trauma_type_anyseq=="tbi_non_severe") 

print('Logistic Regression of hospital mortality')
print(Sys.time())
logreg_hospdeath <- glm(
   inhospital_death ~ prolonged_mec_vent + age + sex + apsiii + charlson,
  data = final_dataset_MIMICIV_tbi_nonsevere,
  family = binomial())
print(Sys.time())
```
...
# Save PMV's OR for this specific subset 
or_hospdeath_mimiciv_tbi_nonsevere <- or_hospdeath_1[or_hospdeath_1[,1]=="prolonged_mec_vent", c(1,6:8)]
or_hospdeath_mimiciv_tbi_nonsevere[, 1] <- "PMV for TBI non-severe"
...
# Save OR table and print in console
write.csv(or_hospdeath_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/or_hospdeath_PMV-for-TBI-nonsevere_mimiciv.csv')
htmlTable(or_hospdeath_2[,c("term","OR","OR_lower","OR_upper")], caption = "Logistic Regression. Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors. Subset of TBI non-severe. MIMIC-IV Database")
...
or_table <- or_hospdeath_2 %>%
  ...
  mutate(
    ...
    OR_upper = ifelse(OR_upper <= 100, sprintf("%.2f", OR_upper), sprintf("%.2e", OR_upper))) %>%
  arrange(desc(term)) %>%
  kbl(caption = "Logistic Regression. Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors. Subset of TBI non-severe. MIMIC-IV Database" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Odds_ratio/or_hospdeath_PMV-for-TBI-nonsevere_mimiciv.png",
             zoom = 10)
...
ggplot(or_hospdeath_2, 
  ...
  geom_errorbarh(height = 0.2, aes(color = adverse_protective)) +
  geom_vline(xintercept = 1, linetype = "dashed") +
  labs(x = "Odds Ratio", y = NULL, title = "Logistic Regression. Odds Ratio and Confidence Intervals\nfor Hospital Mortality-associated Factors.\nSubset of TBI non-severe. MIMIC-IV Database") +
  theme_minimal() +
  scale_color_manual(
    values = c("#c0392b", "#27ae60", "gray70"),
    labels = c("Adverse", "Protective", "Inconclusive"),
...
# Save the Forest plot as a PNG file
ggsave("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Forest_plot/fp_deathyear_PMV-for-TBI-nonsevere_mimiciv.png", width = 10, height = 4, dpi = 300)
```
...
```{r}
# Create subset with tbi_severe
final_dataset_MIMICIV_trauma_not_tbi <- subset(final_dataset_MIMICIV, final_dataset_MIMICIV$trauma_type_anyseq=="trauma_non_tbi") 

print('Logistic Regression of hospital mortality')
print(Sys.time())
logreg_hospdeath <- glm(
   inhospital_death ~ prolonged_mec_vent + age + sex + apsiii + charlson,
  data = final_dataset_MIMICIV_trauma_not_tbi,
  family = binomial())
print(Sys.time())
```
...
# Save PMV's OR for this specific subset 
or_hospdeath_mimiciv_trauma_not_tbi <- or_hospdeath_1[or_hospdeath_1[,1]=="prolonged_mec_vent", c(1,6:8)]
or_hospdeath_mimiciv_trauma_not_tbi[, 1] <- "PMV for Trauma not-TBI"
...
# Save OR table and print in console
write.csv(or_hospdeath_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/or_hospdeath_PMV-for-Trauma-not-TBI_mimiciv.csv')
htmlTable(or_hospdeath_2[,c("term","OR","OR_lower","OR_upper")], caption = "Logistic Regression. Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors. Subset of Trauma not TBI. MIMIC-IV Database")
...
or_table <- or_hospdeath_2 %>%
  ...
  mutate(
    ...
    OR_upper = ifelse(OR_upper <= 100, sprintf("%.2f", OR_upper), sprintf("%.2e", OR_upper))) %>%
  arrange(desc(term)) %>%
  kbl(caption = "Logistic Regression. Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors. Subset of Trauma not TBI. MIMIC-IV Database" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Odds_ratio/or_hospdeath_PMV-for-Trauma-not-TBI_mimiciv.png",
             zoom = 10)
...
ggplot(or_hospdeath_2, 
  ...
  geom_errorbarh(height = 0.2, aes(color = adverse_protective)) +
  geom_vline(xintercept = 1, linetype = "dashed") +
  labs(x = "Odds Ratio", y = NULL, title = "Logistic Regression. Odds Ratio and Confidence Intervals\nfor Hospital Mortality-associated Factors.\nSubset of Trauma not TBI. MIMIC-IV Database") +
  theme_minimal() +
  scale_color_manual(
    values = c("#c0392b", "#27ae60", "gray70"),
    labels = c("Adverse", "Protective", "Inconclusive"),
...
# Save the Forest plot as a PNG file
ggsave("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Forest_plot/fp_deathyear_PMV-for-Trauma-not-TBI_mimiciv.png", width = 10, height = 4, dpi = 300)
```
...
```{r}
# Create subset with tbi_severe
final_dataset_MIMICIV_non_trauma <- subset(final_dataset_MIMICIV, final_dataset_MIMICIV$trauma_type_anyseq=="non_trauma") 

print('Logistic Regression of hospital mortality')
print(Sys.time())
logreg_hospdeath <- glm(
   inhospital_death ~ prolonged_mec_vent + age + sex + apsiii + charlson,
  data = final_dataset_MIMICIV_non_trauma,
  family = binomial())
print(Sys.time())
```
...
# Save PMV's OR for this specific subset 
or_hospdeath_mimiciv_not_trauma <- or_hospdeath_1[or_hospdeath_1[,1]=="prolonged_mec_vent", c(1,6:8)]
or_hospdeath_mimiciv_not_trauma[, 1] <- "PMV for non Trauma"
...
# Save OR table and print in console
write.csv(or_hospdeath_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/or_hospdeath_PMV-for-non-Trauma_mimiciv.csv')
htmlTable(or_hospdeath_2[,c("term","OR","OR_lower","OR_upper")], caption = "Logistic Regression. Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors. Subset of not Trauma. MIMIC-IV Database")
...
or_table <- or_hospdeath_2 %>%
  ...
  mutate(
    ...
    OR_upper = ifelse(OR_upper <= 100, sprintf("%.2f", OR_upper), sprintf("%.2e", OR_upper))) %>%
  arrange(desc(term)) %>%
  kbl(caption = "Logistic Regression. Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors. Subset of not Trauma. MIMIC-IV Database" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Odds_ratio/or_hospdeath_PMV-for-non-Trauma_mimiciv.png",
             zoom = 10)
...
ggplot(or_hospdeath_2, 
  ...
  geom_errorbarh(height = 0.2, aes(color = adverse_protective)) +
  geom_vline(xintercept = 1, linetype = "dashed") +
  labs(x = "Odds Ratio", y = NULL, title = "Logistic Regression. Odds Ratio and Confidence Intervals\nfor Hospital Mortality-associated Factors.\nSubset of not Trauma. MIMIC-IV Database") +
  theme_minimal() +
  scale_color_manual(
    values = c("#c0392b", "#27ae60", "gray70"),
    labels = c("Adverse", "Protective", "Inconclusive"),
...
# Save the Forest plot as a PNG file
ggsave("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Forest_plot/fp_deathyear_PMV-for-non-Trauma_mimiciv.png", width = 10, height = 4, dpi = 300)
```
...
MIMICIV_OR_PMV <- rbind(or_hospdeath_mimiciv_tbi_severe, or_hospdeath_mimiciv_tbi_nonsevere, or_hospdeath_mimiciv_trauma_not_tbi, or_hospdeath_mimiciv_not_trauma)

# Order variables
variable_order <- rev(c("Non Trauma", "non-TBI Trauma", "non-severe TBI", "severe TBI"))

# Assign proper names to OR table
MIMICIV_OR_PMV_2 <- MIMICIV_OR_PMV %>% 
  mutate(term = case_when(term == "(Intercept)" ~ "Intercept",
...
# Save OR table and print in console
write.csv(MIMICIV_OR_PMV_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/OR_hospdeath_PMV_all-trauma_mimiciv.csv')
htmlTable(MIMICIV_OR_PMV_2[,c("term","OR","OR_lower","OR_upper")], caption = "Odds Ratio and Confidence Intervals for factors associated with hospital mortality. All types of trauma. MIMIC-IV Database")

# Export OR table as kable 
or_table <- MIMICIV_OR_PMV_2 %>%
  select(term, OR, OR_lower, OR_upper) %>%
  mutate(
    term = factor(term, levels = variable_order),
    OR_upper = ifelse(OR_upper <= 100, sprintf("%.2f", OR_upper), sprintf("%.2e", OR_upper))) %>%
...
# Build the Forest plot
fp_PMV_alltraumas_hospdeath_mimiciv <- ggplot(MIMICIV_OR_PMV_2, 
       aes(x = OR, xmin = OR_lower, xmax = OR_upper, y = term)) +
  geom_point(size = 2, aes(color = adverse_protective)) +
  geom_errorbarh(height = 0.2, aes(color = adverse_protective)) +
  geom_vline(xintercept = 1, linetype = "dashed") +
...
## 1-year Mortality: PMV and trauma types
...
## 1-year Mortality: PMV and TBI-severe
...
# Save PMV's OR for this specific subset 
or_deathyear_mimiciv_tbi_severe <- or_deathyear_1[or_deathyear_1[,1]=="prolonged_mec_vent", c(1,6:8)]
or_deathyear_mimiciv_tbi_severe[, 1] <- "PMV for TBI severe"
...
# Save OR table and print in console
write.csv(or_deathyear_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/or_deathyear_PMV-for-TBI-severe_mimiciv.csv')
htmlTable(or_deathyear_2[,c("term","OR","OR_lower","OR_upper")], caption = "Logistic Regression. Odds Ratio and Confidence Intervals for factors associated with death at year. Subset of TBI severe. MIMIC-IV Database")
...
or_table <- or_deathyear_2 %>%
  ...
  mutate(
    ...
    OR_upper = ifelse(OR_upper <= 100, sprintf("%.2f", OR_upper), sprintf("%.2e", OR_upper))) %>%
  arrange(desc(term)) %>%
  kbl(caption = "Logistic Regression. Odds Ratio and Confidence Intervals for factors associated with death at year. Subset of TBI severe. MIMIC-IV Database" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Odds_ratio/or_deathyear_PMV-for-TBI-severe_mimiciv.png",
             zoom = 10)
...
ggplot(or_deathyear_2, 
  ...
  geom_errorbarh(height = 0.2, aes(color = adverse_protective)) +
  geom_vline(xintercept = 1, linetype = "dashed") +
  labs(x = "Odds Ratio", y = NULL, title = "Logistic Regression. Odds Ratio and Confidence Intervals\nfor factors associated with death at year.\nSubset of TBI severe. MIMIC-IV Database") +
  theme_minimal() +
  scale_color_manual(
    values = c("#c0392b", "#27ae60", "gray70"),
    labels = c("Adverse", "Protective", "Inconclusive"),
...
## 1-year Mortality: PMV and TBI-non severe
...
# Save PMV's OR for this specific subset 
or_deathyear_mimiciv_tbi_nonsevere <- or_deathyear_1[or_deathyear_1[,1]=="prolonged_mec_vent", c(1,6:8)]
or_deathyear_mimiciv_tbi_nonsevere[, 1] <- "PMV for TBI non-severe"
...
# Save OR table and print in console
write.csv(or_deathyear_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/or_deathyear_PMV-for-TBI-nonsevere_mimiciv.csv')
htmlTable(or_deathyear_2[,c("term","OR","OR_lower","OR_upper")], caption = "Logistic Regression. Odds Ratio and Confidence Intervals for factors associated with death at year. Subset of TBI non-severe. MIMIC-IV Database")
...
or_table <- or_deathyear_2 %>%
  ...
  mutate(
    ...
    OR_upper = ifelse(OR_upper <= 100, sprintf("%.2f", OR_upper), sprintf("%.2e", OR_upper))) %>%
  arrange(desc(term)) %>%
  kbl(caption = "Logistic Regression. Odds Ratio and Confidence Intervals for factors associated with death at year. Subset of TBI non-severe. MIMIC-IV Database" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Odds_ratio/or_deathyear_PMV-for-TBI-nonsevere_mimiciv.png",
             zoom = 10)
...
## 1-year Mortality: PMV and Trauma not-TBI
...
# Save PMV's OR for this specific subset 
or_deathyear_mimiciv_trauma_not_tbi <- or_deathyear_1[or_deathyear_1[,1]=="prolonged_mec_vent", c(1,6:8)]
or_deathyear_mimiciv_trauma_not_tbi[, 1] <- "PMV for Trauma not-TBI"
...
# Save OR table and print in console
write.csv(or_deathyear_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/or_deathyear_PMV-for-Trauma-not-TBI_mimiciv.csv')
htmlTable(or_deathyear_2[,c("term","OR","OR_lower","OR_upper")], caption = "Logistic Regression. Odds Ratio and Confidence Intervals for factors associated with death at year. Subset of Trauma not TBI. MIMIC-IV Database")
...
or_table <- or_deathyear_2 %>%
  ...
  mutate(
    ...
    OR_upper = ifelse(OR_upper <= 100, sprintf("%.2f", OR_upper), sprintf("%.2e", OR_upper))) %>%
  arrange(desc(term)) %>%
  kbl(caption = "Logistic Regression. Odds Ratio and Confidence Intervals for factors associated with death at year. Subset of Trauma not TBI. MIMIC-IV Database" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Odds_ratio/or_deathyear_PMV-for-Trauma-not-TBI_mimiciv.png",
             zoom = 10)
...
## 1-year Mortality: PMV and non Trauma
...
# Save PMV's OR for this specific subset 
or_deathyear_mimiciv_not_trauma <- or_deathyear_1[or_deathyear_1[,1]=="prolonged_mec_vent", c(1,6:8)]
or_deathyear_mimiciv_not_trauma[, 1] <- "PMV for non Trauma"
...
# Save OR table and print in console
write.csv(or_deathyear_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/or_deathyear_PMV-for-non-Trauma_mimiciv.csv')
htmlTable(or_deathyear_2[,c("term","OR","OR_lower","OR_upper")], caption = "Logistic Regression. Odds Ratio and Confidence Intervals for factors associated with death at year. Subset of not Trauma. MIMIC-IV Database")
...
or_table <- or_deathyear_2 %>%
  ...
  mutate(
    ...
    OR_upper = ifelse(OR_upper <= 100, sprintf("%.2f", OR_upper), sprintf("%.2e", OR_upper))) %>%
  arrange(desc(term)) %>%
  kbl(caption = "Logistic Regression. Odds Ratio and Confidence Intervals for factors associated with death at year. Subset of not Trauma. MIMIC-IV Database" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Odds_ratio/or_deathyear_PMV-for-non-Trauma_mimiciv.png",
             zoom = 10)
...
```{r}
# Obtain combined table
MIMICIV_OR_PMV <- rbind(or_deathyear_mimiciv_tbi_severe, or_deathyear_mimiciv_tbi_nonsevere, or_deathyear_mimiciv_trauma_not_tbi, or_deathyear_mimiciv_not_trauma)
...
# Save OR table and print in console
write.csv(MIMICIV_OR_PMV_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/OR_deathyear_PMV_all-trauma_mimiciv.csv')
htmlTable(MIMICIV_OR_PMV_2[,c("term","OR","OR_lower","OR_upper")], caption = "Odds Ratio and Confidence Intervals for factors associated with death at year. All types of trauma. MIMIC-IV Database")
...
or_table <- MIMICIV_OR_PMV_2 %>%
  ...
  mutate(
    ...
    OR_upper = ifelse(OR_upper <= 100, sprintf("%.2f", OR_upper), sprintf("%.2e", OR_upper))) %>%
  arrange(desc(term)) %>%
  kbl(caption = "Logistic Regression. Odds Ratio and Confidence Intervals for factors associated with death at year. All types of trauma. MIMIC-IV Database" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
...
# Build the Forest plot
fp_PMV_alltraumas_deathyear_mimiciv <- ggplot(MIMICIV_OR_PMV_2, 
       aes(x = OR, xmin = OR_lower, xmax = OR_upper, y = term)) +
  geom_point(size = 2, aes(color = adverse_protective)) +
  geom_errorbarh(height = 0.2, aes(color = adverse_protective)) +
  geom_vline(xintercept = 1, linetype = "dashed") +
