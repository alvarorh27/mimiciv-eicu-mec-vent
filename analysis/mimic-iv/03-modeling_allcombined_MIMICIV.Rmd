...
dict_terms <- c(
  ...
  "trauma_type_anyseqno trauma" = "Non Trauma",
  ...
  "prolonged_mec_vent:trauma_type_anyseqno trauma" = "PMV + Non Trauma",
...
```{r}
# Multivariate analysis
## Recategorize "no trauma" as reference level in trauma_type_anyseq variable
final_dataset_recategorized <- recategorize_function(final_dataset_MIMICIV, "trauma_type_anyseq", "no trauma")
...
print('Logistic Regression of hospital mortality')
logreg <- glm(
   inhospital_death ~ prolonged_mec_vent * tbi_anyseq + age + sex + apsiii + charlson,
  data = final_dataset_recategorized,
  family = binomial())
...
non_trauma_summary <- create_summary_table(final_dataset_MIMICIV, death_outcome="inhospital_death", "trauma_type_anyseq", "Non Trauma", "no trauma")
...
print('Logistic Regression of mortality at 1 year')
logreg <- glm(
   death_year ~ prolonged_mec_vent * tbi_anyseq + age + sex + apsiii + charlson,
  data = final_dataset_recategorized,
  family = binomial())
...
non_trauma_summary <- create_summary_table(final_dataset_MIMICIV, death_outcome="death_year", "trauma_type_anyseq", "Non Trauma", "no trauma")
