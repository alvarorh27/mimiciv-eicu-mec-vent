...
final_dataset_recategorized <- recategorize_function(final_dataset_eICU, "trauma_type_anyseq", "no trauma")
...
non_trauma_summary <- create_summary_table(final_dataset_eICU, death_outcome="inhospital_death", "trauma_type_anyseq", "Non Trauma", "no trauma")
