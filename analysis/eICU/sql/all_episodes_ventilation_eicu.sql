...
from vd3),
    ...
    WHERE
      oxygen_therapy_type=4) /*Create ventilation times variables. 47857 rows*/
    SELECT
      uniquepid AS subject_id,
      patienthealthsystemstayid AS hadm_id,
      icustay_id AS stay_id,
      icu_admit_time,
      TIMESTAMP_ADD(icu_admit_time, INTERVAL unitdischargeoffset MINUTE) AS icu_outtime /*Calculates the ICU outtime timedate from intime and unitdischargeoffset*/,
      unitvisitnumber,
      ventnum,
      vent_start,
      starttime,
