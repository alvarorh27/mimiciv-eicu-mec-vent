...
FROM (
  ...
  FROM (
    ...
    GROUP BY
      ...
      traumatic_general_any_seq
    HAVING
      traumatic_general_any_seq=1
      OR traumatic_general_seq_1=1-- group when there is Traumatic general injury
    ORDER BY
      subject_id,
      hadm_id,
      traumatic_general_seq_1))
WHERE
  NOT (hadm_id=prev_hadm_id
    AND traumatic_general_seq_1=0
    AND traumatic_general_any_seq=1) --look at word
ORDER BY
  subject_id,
  hadm_id
