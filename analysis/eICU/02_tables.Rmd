...
vars_in_table1<-c('age', 'gender', 'hospital_stay_days_all', 'icu_stay_days', 'discharge_location', 'inhospital_death', 'inicu_death', 'death_30days', 'tbi_seq1', 'tbi_anyseq', 'anytrauma_seq1','anytrauma_anyseq', 'tbi_severe_seq1', 'tbi_nonsevere_seq1', 'trauma_type_seq1', 'tbi_severe_anyseq', 'tbi_nonsevere_anyseq', 'trauma_type_anyseq', 'consecutive_vm_days', 'mv_consecutive_7days', 'mv_consecutive_14days', 'mv_consecutive_21days', 'prolonged_mec_vent', 'gcs_min') 
...
# Export kable 
  table1_tbi %>%
   ...
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "No", "Yes", "", "")) %>%
   save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/eICU/table1_tbi_eicu.jpg", zoom = 10)
...
#Export kable
 table1_pmv %>%  
   ...
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "No", "Yes", "", "")) %>% 
   save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/eICU/table1_pmv_eicu.jpg", zoom = 10)
```
...
# For console
 table1_death30days %>%
   kbl(caption = "Table 1 of base model: Mortality at 30 days. eICU Database" , align = "c") %>%
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "No", "Yes", "", ""))
...
# Export kable
 table1_death30days %>%
   ...
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "No", "Yes", "", "")) %>%
   save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/eICU/table1_death30days_eicu.jpg", zoom = 10)
...
# Export kable
 table1_tbi_and_pmv %>%
   ...
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "No TBI and no Mec Vent", "TBI without Mec Vent", "No TBI and Mec Vent",     "TBI + Mec-Vent ", " ", " ")) %>%
   save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/eICU/table1_tbi_and_pmv_eicu.jpg", zoom = 10)
```