...
logreg_hospdeath <- glm(
   inhospital_death ~ age + gender + prolonged_mec_vent + sapsii + charlson,
...
variable_order <- rev(c(
  "Intercept", "Age (years)", "Gender (male)", "TBI as any diagnostic order", "Severe TBI as any diagnostics", "Traumatism as any diagnostic order", "Consecutive days with >6 hour ventilation", "PMV > consecutive 7 days", "PMV > consecutive 14 days", "PMV > consecutive 21 days", "MV for 96h + traqueostomy", "PMV - Prolonged Mechanical Ventilation"))
...
write.csv(or_hospdeath_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/or_hospdeath_PMV.csv')
htmlTable(or_hospdeath_2[,c("term","OR","OR_lower","OR_upper")], caption = "Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors")
...
or_table <- or_hospdeath_2 %>%
  ...
  arrange(desc(term)) %>%
  kbl(caption = "Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Odds_ratio/or_hospdeath_PMV.png",
             zoom = 10)
...
ggplot(or_hospdeath_2, 
  ...
  labs(x = "Odds Ratio", y = NULL, title = "Odds Ratio and Confidence Intervals\nfor Hospital Mortality-associated Factors") +
  theme_minimal() +
  scale_color_manual(
...
ggsave("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Forest_plot/fp_hospdeath_PMV.png", width = 10, height = 4, dpi = 300)
```
...
print(Sys.time())
logreg_hospdeath <- glm(
   inhospital_death ~ age + gender + trauma_type_anyseq + sapsii + charlson,
  data = final_dataset_MIMICIV,
  family = binomial())
print(Sys.time())
```
...
# Order variables
variable_order <- rev(c(
  "Intercept", "Age (years)", "Gender (male)", "TBI - non severe", "TBI - severe", "Trauma-not TBI"))
...
# Save OR table and print in console
write.csv(or_hospdeath_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/or_hospdeath_TBI.csv')
htmlTable(or_hospdeath_2[,c("term","OR","OR_lower","OR_upper")], caption = "Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors")
...
or_table <- or_hospdeath_2 %>%
  ...
  kbl(caption = "Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Odds_ratio/or_hospdeath_TBI.png",
             zoom = 10)
...
# Save the Forest plot as a PNG file
ggsave("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Forest_plot/fp_hospdeath_TBI.png", width = 10, height = 4, dpi = 300)
```
...
print(Sys.time())
logreg_hospdeath <- glm(
   inhospital_death ~ prolonged_mec_vent * trauma_type_anyseq + age + gender + sapsii + charlson,
  data = final_dataset_MIMICIV,
  family = binomial())
print(Sys.time())
```
...
# Order variables
variable_order <- rev(c(
  "Intercept", "Age (years)", "Gender (male)", "PMV", "TBI-non severe", "TBI-severe", "Trauma-not TBI", "PMV + TBI-non severe", "PMV + TBI-severe", "PMV + Trauma - no TBI"))
...
# Save OR table and print in console
write.csv(or_hospdeath_2,'C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/data/mimic-iv/or_hospdeath_PMV-TBI.csv')
htmlTable(or_hospdeath_2[,c("term","OR","OR_lower","OR_upper")], caption = "Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors")
...
or_table <- or_hospdeath_2 %>%
  ...
  kbl(caption = "Odds Ratio and Confidence Intervals for Hospital Mortality-associated Factors" , align = "c") %>%
  kable_classic_2(full_width = F, html_font = "Cambria") %>%
  save_kable("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Odds_ratio/or_hospdeath_PMV-TBI.png",
             zoom = 10)
...
# Save the Forest plot as a PNG file
ggsave("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Forest_plot/fp_hospdeath_PMV-TBI.png", width = 10, height = 4, dpi = 300)
```
...
ggplot(final_dataset_MIMICIV, aes(x = prolonged_mec_vent, y = inhospital_death, color = factor(trauma_type_anyseq))) +
  ...
  labs(x = "Prolonged Mechanical Ventilation", y = "Hospital Mortality", color = "Type of Trauma", title = "Interaction Effect of PMV and Trauma types on Hospital Death") +
  theme_minimal()

# Save the plot as a PNG file
ggsave("C:/Users/se_al/Documents/GitHub/mimiciv-mec-vent/figures/mimic-iv/Forest_plot/interactionplot_PMV-TBI.png", width = 6, height = 4, dpi = 300)
